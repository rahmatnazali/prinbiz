...
public interface DNSStatefulObject {
    ...
    public static final class DNSStatefulObjectSemaphore {
        ...
        static {
            logger = Logger.getLogger(DNSStatefulObjectSemaphore.class.getName());
        }
        ...
        public String toString() {
            StringBuilder aLog = new StringBuilder(DNSConstants.PROBE_CONFLICT_INTERVAL);
    ...
    public static class DefaultImplementation extends ReentrantLock implements DNSStatefulObject {
        ...
        static {
            logger = Logger.getLogger(DefaultImplementation.class.getName());
        }
        ...
        public DefaultImplementation() {
            ...
            this._announcing = new DNSStatefulObjectSemaphore("Announce");
            this._canceling = new DNSStatefulObjectSemaphore("Cancel");
        }

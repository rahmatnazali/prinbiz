...
public class Prober extends DNSStateTask {
    ...
    static {
        logger = Logger.getLogger(Prober.class.getName());
    }
    ...
    public String getName() {
        return "Prober(" + (getDns() != null ? getDns().getName() : XmlPullParser.NO_NAMESPACE) + ")";
    }
    ...
    public void start(Timer timer) {
        ...
        if (getDns().isAnnounced() && getDns().getThrottle() < 10) {
            timer.schedule(this, (long) JmDNSImpl.getRandom().nextInt(TelnetCommand.WILL), 250);

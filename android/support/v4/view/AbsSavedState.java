...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C05491 extends AbsSavedState {
        C05491() {
            super();
        }
    }
    ...
    static class C05502 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C05502() {
        }
    ...
    static {
        EMPTY_STATE = new C05491();
        CREATOR = ParcelableCompat.newCreator(new C05502());
    }

...
public final class ViewPropertyAnimatorCompat {
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        public void m387x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        public void m388y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        public void m389z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
        ...
        private void postStartMessage(ViewPropertyAnimatorCompat vpa, View view) {
            ...
            if (runnable == null) {
                runnable = new Starter(vpa, view, null);
                if (this.mStarterMap == null) {
    ...
    static class ICSViewPropertyAnimatorCompatImpl extends BaseViewPropertyAnimatorCompatImpl {
        ...
        public void m687x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            ViewPropertyAnimatorCompatICS.m6x(view, value);
        }
        ...
        public void m688y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            ViewPropertyAnimatorCompatICS.m7y(view, value);
        }
    ...
    static class LollipopViewPropertyAnimatorCompatImpl extends KitKatViewPropertyAnimatorCompatImpl {
        ...
        public void m710z(ViewPropertyAnimatorCompat vpa, View view, float value) {
            ViewPropertyAnimatorCompatLollipop.m8z(view, value);
        }
    ...
    public ViewPropertyAnimatorCompat m3x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.m0x(this, view, value);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat m4y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.m1y(this, view, value);
        }
        return this;
    }
    ...
    public ViewPropertyAnimatorCompat m5z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.m2z(this, view, value);
        }
        return this;
    }

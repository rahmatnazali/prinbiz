...
public class ViewPager extends ViewGroup {
    ...
    static class C00871 implements Comparator<ItemInfo> {
        C00871() {
        }
    ...
    static class C00882 implements Interpolator {
        C00882() {
        }
    ...
    class C05544 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C05551 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05551() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05551());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00871();
        sInterpolator = new C00882();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00893();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05544());
    }
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapter != null) {
            ...
            for (i = SCROLL_STATE_IDLE; i < this.mItems.size(); i += SCROLL_STATE_DRAGGING) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & TelnetOption.MAX_OPTION_VALUE;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            if (this.mAdapter.getCount() != 0) {
                ...
                float x;
                switch (action & TelnetOption.MAX_OPTION_VALUE) {
                    case SCROLL_STATE_IDLE /*0*/:
                        this.mScroller.abortAnimation();
                        this.mPopulatePending = DEBUG;
                        populate();
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(DNSConstants.PROBE_CONFLICT_INTERVAL, (float) this.mMaximumVelocity);
                            ...
                            x = (float) scrollX;
                            float f = (float) width;
                            float pageOffset = ((r0 / r0) - ii.offset) / (ii.widthFactor + marginOffset);
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (((float) this.mPageMargin) + drawAt > ((float) scrollX)) {
                    ...
                    this.mMarginDrawable.setBounds(Math.round(drawAt), this.mTopPageBounds, Math.round(r0 + drawAt), this.mBottomPageBounds);

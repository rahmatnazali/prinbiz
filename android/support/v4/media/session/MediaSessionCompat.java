...
public class MediaSessionCompat {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        static class C00591 implements Creator<QueueItem> {
            C00591() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        ...
        static class C00601 implements Creator<ResultReceiverWrapper> {
            C00601() {
            }
    ...
    public static final class Token implements Parcelable {
        ...
        static class C00611 implements Creator<Token> {
            C00611() {
            }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class C05451 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C05451() {
            }
        ...
        class C08222 implements Callback {
            C08222() {
            }
        ...
        class MediaSessionStub extends Stub {
            ...
            public void sendCommand(String command, Bundle args, ResultReceiverWrapper cb) {
                MediaSessionImplBase.this.postToHandler(MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS, new Command(command, args, cb.mResultReceiver));
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
            ...
            this.mVolumeCallback = new C05451();
            if (mbrComponent == null) {
                ...
                if (resolveInfos.size() == MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS) {
                ...
                } else if (resolveInfos.size() > MediaSessionCompat.FLAG_HANDLES_MEDIA_BUTTONS) {

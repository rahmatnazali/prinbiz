...
public class TransportMediator extends TransportController {
    ...
    class C00492 implements Callback {
        C00492() {
        }
    ...
    class C05431 implements TransportMediatorCallback {
        C05431() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C05431();
        this.mKeyEventCallback = new C00492();

...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private class ServiceBinderImpl {
        ...
        class C00391 implements Runnable {
            ...
            C00391(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00402 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C00402(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C00413 implements Runnable {
            ...
            C00413(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
        ...
        class C00424 implements Runnable {
            ...
            C00424(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$token = iBinder;
            }
        ...
        class C00435 implements Runnable {
            ...
            C00435(ServiceCallbacks serviceCallbacks, String str, ResultReceiver resultReceiver) {
                this.val$callbacks = serviceCallbacks;
        ...
        class C00446 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;
            final /* synthetic */ Bundle val$rootHints;

            C00446(ServiceCallbacks serviceCallbacks, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$rootHints = bundle;
            }
        ...
        class C00457 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C00457(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00391(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00402(callbacks));
        }

        public void addSubscription(String id, IBinder token, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00413(callbacks, id, token, options));
        }

        public void removeSubscription(String id, IBinder token, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00424(callbacks, id, token));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver, ServiceCallbacks callbacks) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00435(callbacks, mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks, Bundle rootHints) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00446(callbacks, rootHints));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C00457(callbacks));
        }
    }
    ...
    private final class ServiceHandler extends Handler {
        ...
        private ServiceHandler() {
            this.mServiceBinderImpl = new ServiceBinderImpl(null);
        }
    ...
    class C05381 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C05381(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C05392 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C05392(Object debug, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(debug);
        }
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        class C00361 implements Runnable {
            ...
            C00361(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        class C05402 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C05402(Object debug, ResultWrapper resultWrapper) {
        ...
        public void notifyChildrenChanged(String parentId, Bundle options) {
            if (this.mMessenger == null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new C00361(parentId, options));
            }
        }
        ...
        public void onLoadChildren(String parentId, ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C05402(parentId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        class C00382 implements Runnable {
            ...
            C00382(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        public void setSessionToken(Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00371(token));
        }

        public void notifyChildrenChanged(@NonNull String parentId, Bundle options) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00382(parentId, options));
        }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        class C05411 extends Result<MediaItem> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C05411(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadItem(String itemId, ResultWrapper<Parcel> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadItem(itemId, new C05411(itemId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        class C05421 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C05421(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadChildren(String parentId, ResultWrapper resultWrapper, Bundle options) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C05421(parentId, resultWrapper), options);
        }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C05381(parentId, connection, parentId, options);
    ...
    private void performLoadItem(String itemId, ConnectionRecord connection, ResultReceiver receiver) {
        Result<MediaItem> result = new C05392(itemId, receiver);
        this.mCurConnection = connection;

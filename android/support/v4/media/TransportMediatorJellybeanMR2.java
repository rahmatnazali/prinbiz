...
class TransportMediatorJellybeanMR2 {
    ...
    class C00501 implements OnWindowAttachListener {
        C00501() {
        }
    ...
    class C00512 implements OnWindowFocusChangeListener {
        C00512() {
        }
    ...
    class C00534 implements OnAudioFocusChangeListener {
        C00534() {
        }
    ...
    class C00545 implements OnGetPlaybackPositionListener {
        C00545() {
        }
    ...
    class C00556 implements OnPlaybackPositionUpdateListener {
        C00556() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00501();
        this.mWindowFocusListener = new C00512();
        this.mMediaButtonReceiver = new C00523();
        this.mAudioFocusChangeListener = new C00534();
        this.mGetPlaybackPositionListener = new C00545();
        this.mPlaybackPositionUpdateListener = new C00556();
        this.mPlayState = 0;

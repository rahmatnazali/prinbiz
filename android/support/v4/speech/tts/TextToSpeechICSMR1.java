...
class TextToSpeechICSMR1 {
    ...
    static class C00731 extends UtteranceProgressListener {
    ...
    static class C00742 implements OnUtteranceCompletedListener {
        final /* synthetic */ UtteranceProgressListenerICSMR1 val$listener;
    ...
    static void setUtteranceProgressListener(TextToSpeech tts, UtteranceProgressListenerICSMR1 listener) {
        if (VERSION.SDK_INT >= 15) {
            tts.setOnUtteranceProgressListener(new C00731(listener));
        } else {
            tts.setOnUtteranceCompletedListener(new C00742(listener));
        }
    }
}

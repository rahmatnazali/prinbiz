...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    public int getOpacity() {
        if (this.mGravity != NNTP.DEFAULT_PORT || this.mIsCircular) {
            return -3;
        }
        Bitmap bm = this.mBitmap;
        if (bm == null || bm.hasAlpha() || this.mPaint.getAlpha() < TelnetOption.MAX_OPTION_VALUE || isGreaterThanZero(this.mCornerRadius)) {
            return -3;
        }
        return -1;
    }
    ...
    RoundedBitmapDrawable(Resources res, Bitmap bitmap) {
        ...
        this.mGravity = NNTP.DEFAULT_PORT;

...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C00071 implements Creator<SavedState> {
            C00071() {
            }
    ...
    class C05321 extends FragmentContainer {
        C05321() {
        }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        if (!this.mUserVisibleHint && isVisibleToUser && this.mState < STARTED && this.mFragmentManager != null && isAdded()) {
            this.mFragmentManager.performPendingDeferredStart(this);
        }
        this.mUserVisibleHint = isVisibleToUser;
        boolean z = this.mState < STARTED && !isVisibleToUser;
        this.mDeferStart = z;
    }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C05321(), this);
    }

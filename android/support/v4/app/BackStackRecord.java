...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00052 implements OnPreDrawListener {
        ...
        C00052(View view, Object obj, ArrayList arrayList, TransitionState transitionState, Object obj2, Object obj3, boolean z, Fragment fragment, Fragment fragment2) {
        ...
        public boolean onPreDraw() {
            ...
            FragmentTransitionCompat21.excludeSharedElementViews(this.val$enterTransition, this.val$exitTransition, this.val$sharedElementTransition, this.val$sharedElementTargets, BackStackRecord.SUPPORTS_TRANSITIONS);
    ...
    class C00063 implements OnPreDrawListener {
        final /* synthetic */ int val$containerId;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ TransitionState val$state;
        final /* synthetic */ Object val$transition;

        C00063(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
    ...
    class C05311 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C05311(Fragment fragment) {
            this.val$inFragment = fragment;
        }
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        ViewRetriever c05311 = new C05311(inFragment);
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition, sceneRoot, c05311, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
    ...
    private void prepareSharedElementTransition(TransitionState state, View sceneRoot, Object sharedElementTransition, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayList<View> sharedElementTargets, Object enterTransition, Object exitTransition) {
        if (sharedElementTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00052(sceneRoot, sharedElementTransition, sharedElementTargets, state, enterTransition, exitTransition, isBack, inFragment, outFragment));
        }
    }
    ...
    private void excludeHiddenFragmentsAfterEnter(View sceneRoot, TransitionState state, int containerId, Object transition) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00063(sceneRoot, state, containerId, transition));
    }

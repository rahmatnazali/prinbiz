...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        private android.app.Notification.Builder f453b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f453b, action));
        }
        ...
        public Notification build() {
            ...
            this.f453b.setExtras(this.mExtras);
            Notification notification = this.f453b.build();

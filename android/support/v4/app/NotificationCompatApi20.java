...
class NotificationCompatApi20 {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        private android.app.Notification.Builder f448b;
        ...
        public void addAction(Action action) {
            NotificationCompatApi20.addAction(this.f448b, action);
        }
        ...
        public Notification build() {
            this.f448b.setExtras(this.mExtras);
            Notification notification = this.f448b.build();
    ...
    public static boolean getLocalOnly(Notification notif) {
        return (notif.flags & DNSConstants.FLAGS_RD) != 0;
    }
    ...
    public static boolean isGroupSummary(Notification notif) {
        return (notif.flags & RCommandClient.MIN_CLIENT_PORT) != 0;
    }

...
public class ViewDragHelper {
    ...
    static class C01201 implements Interpolator {
        C01201() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C01212();
        if (forParent == null) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(DNSConstants.PROBE_CONFLICT_INTERVAL, this.mMaxVelocity);

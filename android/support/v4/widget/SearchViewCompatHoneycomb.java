...
class SearchViewCompatHoneycomb {
    ...
    static class C01091 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01091(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01102 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01102(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {

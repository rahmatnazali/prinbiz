...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C05641 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05641() {
            }

            public SavedState createFromParcel(Parcel in, ClassLoader loader) {
                return new SavedState(loader, null);
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C05641());
        }
    }

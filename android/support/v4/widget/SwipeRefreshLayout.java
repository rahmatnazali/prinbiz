...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01121 implements AnimationListener {
        C01121() {
        }
    ...
    class C01132 extends Animation {
        C01132() {
        }
    ...
    class C01143 extends Animation {
        C01143() {
        }
    ...
    class C01154 extends Animation {
    ...
    class C01165 implements AnimationListener {
        C01165() {
        }
    ...
    class C01176 extends Animation {
        C01176() {
        }
    ...
    class C01187 extends Animation {
        C01187() {
        }
    ...
    class C01198 extends Animation {
        C01198() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01121();
        this.mAnimateToCorrectPosition = new C01176();
        this.mAnimateToStartPosition = new C01187();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01132();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01143();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01154(startingAlpha, endingAlpha);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01198();

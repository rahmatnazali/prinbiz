...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C01051 extends Animation {
    ...
    class C01062 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    class C01073 implements Callback {
        C01073() {
        }
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            if (this.mAlpha < TelnetOption.MAX_OPTION_VALUE) {
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        int startA = (startInt >> 24) & TelnetOption.MAX_OPTION_VALUE;
        int startR = (startInt >> 16) & TelnetOption.MAX_OPTION_VALUE;
        int startG = (startInt >> 8) & TelnetOption.MAX_OPTION_VALUE;
        int startB = startInt & TelnetOption.MAX_OPTION_VALUE;
        int endInt = Integer.valueOf(endValue).intValue();
        return ((((((int) (((float) (((endInt >> 24) & TelnetOption.MAX_OPTION_VALUE) - startA)) * fraction)) + startA) << 24) | ((((int) (((float) (((endInt >> 16) & TelnetOption.MAX_OPTION_VALUE) - startR)) * fraction)) + startR) << 16)) | ((((int) (((float) (((endInt >> 8) & TelnetOption.MAX_OPTION_VALUE) - startG)) * fraction)) + startG) << 8)) | (((int) (((float) ((endInt & TelnetOption.MAX_OPTION_VALUE) - startB)) * fraction)) + startB);
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C01051(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C01062(ring));

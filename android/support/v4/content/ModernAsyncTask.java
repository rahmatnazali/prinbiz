...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00201 implements ThreadFactory {
    ...
    class C00213 extends FutureTask<Result> {
        C00213(Callable x0) {
            super(x0);
        }
    ...
    class C05362 extends WorkerRunnable<Params, Result> {
        C05362() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C05362();
        this.mFuture = new C00213(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00224.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {

...
final class Utils {
    ...
    static class C05091 extends Handler {
        C05091(Looper x0) {
            super(x0);
        }
    ...
    static String getLogIdsForHunter(BitmapHunter hunter) {
        return getLogIdsForHunter(hunter, XmlPullParser.NO_NAMESPACE);
    }
    ...
    static void log(String owner, String verb, String logId) {
        log(owner, verb, logId, XmlPullParser.NO_NAMESPACE);
    }
    ...
    static boolean parseResponseSourceHeader(String header) {
        ...
        try {
            if (!("CONDITIONAL_CACHE".equals(parts[0]) && Integer.parseInt(parts[1]) == RequestState.REQUEST_CHECK_PRINT_COMPLETE_ERROR)) {
                z = false;
            }
            return z;
    ...
    static void flushStackLocalLeaks(Looper looper) {
        Handler handler = new C05091(looper);

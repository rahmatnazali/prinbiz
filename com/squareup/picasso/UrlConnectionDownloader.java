...
public class UrlConnectionDownloader implements Downloader {
    ...
    static class C05081 extends ThreadLocal<StringBuilder> {
        C05081() {
        }
    ...
    static {
        lock = new Object();
        CACHE_HEADER_BUILDER = new C05081();
    }
    ...
    protected HttpURLConnection openConnection(Uri path) throws IOException {
        ...
        connection.setReadTimeout(ServiceConnection.DEFAULT_TIMEOUT);
        return connection;
    }
    ...
    public Response load(Uri uri, int networkPolicy) throws IOException {
        ...
        if (responseCode >= RequestState.REQUEST_CHECK_PRINT_COMPLETE) {

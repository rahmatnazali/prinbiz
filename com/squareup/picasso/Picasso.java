...
public class Picasso {
    ...
    static class C05041 extends Handler {
        C05041(Looper x0) {
            super(x0);
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new C05051(e2));
                    return;
                }
            }
        }
    ...
    public interface RequestTransformer {
        ...
        static class C08181 implements RequestTransformer {
            C08181() {
            }
    ...
    static {
        HANDLER = new C05041(Looper.getMainLooper());
        singleton = null;
    }

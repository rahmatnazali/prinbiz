...
public class RequestCreator {
    ...
    public void into(ImageView target, Callback callback) {
        ...
        if (target == null) {
            ...
            this.picasso.enqueueAndSubmit(new ImageViewAction(this.picasso, imageView, request, this.memoryPolicy, this.networkPolicy, this.errorResId, this.errorDrawable, requestKey, this.tag, callback2, this.noFade));
        } else {
            this.picasso.cancelRequest(target);
            if (this.setPlaceholder) {
                PicassoDrawable.setPlaceholder(target, getPlaceholderDrawable());

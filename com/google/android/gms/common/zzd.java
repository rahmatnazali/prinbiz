...
class zzd {
    ...
    static final class zzd {
        ...
        class C08371 extends zzc {
            C08371(byte[] bArr) {
                super(bArr);
            }

            protected byte[] zzanm() {
        ...
        static {
            ro = new zza[]{new C08371(zza.zzgv("0\u0082\u0004C0\u0082\u0003+\u00a0\u0003\u0002\u0001\u0002\u0002\t\u0000\u00c2\u00e0\u0087FdJ0\u008d0")), new C08382(zza.zzgv("0\u0082\u0004\u00a80\u0082\u0003\u0090\u00a0\u0003\u0002\u0001\u0002\u0002\t\u0000\u00d5\u0085\u00b8l}\u00d3N\u00f50"))};
        }
    }
    ...
    static abstract class zzc extends zza {
        private static final WeakReference<byte[]> rn;
        private WeakReference<byte[]> rm;

        static {
            rn = new WeakReference(null);
        }
    ...
    private static boolean zzanh() {
        ...
        if (rg == null) {
            try {
                zzsb zza = zzsb.zza(rh, zzsb.KM, "com.google.android.gms.googlecertificates");
                Log.d("GoogleCertificates", "com.google.android.gms.googlecertificates module is loaded");
                rg = com.google.android.gms.common.internal.zzv.zza.zzdu(zza.zziu("com.google.android.gms.common.GoogleCertificatesImpl"));
    ...
    static synchronized Set<zzs> zzani() {
        Set<zzs> set;
        synchronized (zzd.class) {
            if (ri != null) {
                set = ri;
            } else if (rg != null || zzanh()) {
                try {
                    com.google.android.gms.dynamic.zzd zzatc = rg.zzatc();
                    if (zzatc == null) {
                        Log.e("GoogleCertificates", "Failed to get google certificates from remote");
                        set = Collections.EMPTY_SET;
                    } else {
                        ri = zza((IBinder[]) zze.zzad(zzatc));
                        for (Object add : zzd.ro) {
                            ri.add(add);
                        }
                        ri = Collections.unmodifiableSet(ri);
                        set = ri;
                    }
                } catch (RemoteException e) {
    ...
    static synchronized Set<zzs> zzanj() {
        Set<zzs> set;
        synchronized (zzd.class) {
            if (rj != null) {
                set = rj;
                ...
                try {
                    com.google.android.gms.dynamic.zzd zzatd = rg.zzatd();
                    if (zzatd == null) {
                        Log.d("GoogleCertificates", "Failed to get google release certificates from remote");
                        set = Collections.EMPTY_SET;
                    } else {
                        rj = zza((IBinder[]) zze.zzad(zzatd));
                        rj.add(zzd.ro[0]);
                        rj = Collections.unmodifiableSet(rj);
                        set = rj;
                    }
                } catch (RemoteException e) {

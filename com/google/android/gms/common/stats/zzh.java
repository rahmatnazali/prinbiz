...
public class zzh {
    ...
    private static boolean zzci(Context context) {
        if (AU == null) {
            AU = Boolean.valueOf(zzcj(context));
        }
    ...
    public void zza(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        ...
        if (7 == i || 8 == i || 10 == i || 11 == i) {
            try {
                context.startService(new Intent().setComponent(zzd.Az).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", new WakeLockEvent(currentTimeMillis, i, str2, i2, zzf.zzx(list), str, SystemClock.elapsedRealtime(), zzj.zzcm(context), str3, zzf.zzhz(context.getPackageName()), zzj.zzcn(context), j, str4)));
            } catch (Throwable e) {
                Log.wtf(TAG, e);
            }
        }

...
public class zzz {
    ...
    public static int zza(WorkSource workSource) {
        if (Bo != null) {
            try {
                return ((Integer) Bo.invoke(workSource, new Object[0])).intValue();
            } catch (Throwable e) {
    ...
    public static String zza(WorkSource workSource, int i) {
        if (Bq != null) {
            try {
                return (String) Bq.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Throwable e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        }
    ...
    public static void zza(WorkSource workSource, int i, String str) {
        if (Bn != null) {
            ...
            try {
                Bn.invoke(workSource, new Object[]{Integer.valueOf(i), str});
            } catch (Throwable e) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e);
            }
        } else if (Bm != null) {
            try {
                Bm.invoke(workSource, new Object[]{Integer.valueOf(i)});
            } catch (Throwable e2) {

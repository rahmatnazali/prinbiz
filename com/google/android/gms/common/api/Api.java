...
public final class Api<O extends ApiOptions> {
    ...
    public <C extends zze> Api(String str, zza<C, O> com_google_android_gms_common_api_Api_zza_C__O, zzf<C> com_google_android_gms_common_api_Api_zzf_C) {
        ...
        this.mName = str;
        this.rB = com_google_android_gms_common_api_Api_zza_C__O;
        this.rC = null;
        this.rD = com_google_android_gms_common_api_Api_zzf_C;
        this.rE = null;
    }
    ...
    public zzd<?, O> zzanp() {
        return zzant() ? null : this.rB;
    }

    public zza<?, O> zzanq() {
        zzab.zza(this.rB != null, (Object) "This API was constructed with a SimpleClientBuilder. Use getSimpleClientBuilder");
        return this.rB;
    }

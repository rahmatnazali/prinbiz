...
public final class zzapw {
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        if (obj != null) {
            ...
            if (obj instanceof String) {
                stringBuffer2.append("\"").append(zzfy((String) obj)).append("\"");
    ...
    private static void zza(byte[] bArr, StringBuffer stringBuffer) {
        ...
        stringBuffer.append('\"');
        for (byte b : bArr) {
            int i = b & TelnetOption.MAX_OPTION_VALUE;
            if (i == 92 || i == 34) {
    ...
    private static String zzfy(String str) {
        if (!str.startsWith("http") && str.length() > NNTPReply.SERVER_READY_POSTING_ALLOWED) {
            str = String.valueOf(str.substring(0, NNTPReply.SERVER_READY_POSTING_ALLOWED)).concat("[...]");
        }
        return zzia(str);
    }

    public static <T extends zzapv> String zzg(T t) {
        String str;
        String valueOf;
        if (t == null) {
    ...
    private static String zzia(String str) {

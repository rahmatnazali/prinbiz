...
public class zzt implements zzf {
    ...
    static {
        DEBUG = zzs.DEBUG;
        zzbn = 3000;
        zzbo = AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD;
    }
    ...
    private byte[] zza(HttpEntity httpEntity) throws IOException, zzp {
        ...
        try {
            ...
            bArr = this.zzbq.zzb(Util.DEFAULT_COPY_BUFFER_SIZE);
            while (true) {
    ...
    L_0x0004:
        ...
        r0 = r18;
        r4 = r0.zzbp;	 Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x00e2 }
        r0 = r19;

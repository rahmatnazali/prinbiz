...
public final class zzapt {
    ...
    public static final Object bjF;

    static {
        UTF_8 = Charset.forName("UTF-8");
        ISO_8859_1 = Charset.forName(FTP.DEFAULT_CONTROL_ENCODING);
        bjF = new Object();
    }
    ...
    public static void zza(zzapp com_google_android_gms_internal_zzapp, zzapp com_google_android_gms_internal_zzapp2) {
        if (com_google_android_gms_internal_zzapp.bjx != null) {
            com_google_android_gms_internal_zzapp2.bjx = (zzapr) com_google_android_gms_internal_zzapp.bjx.clone();
        }
    }

...
public class zzc extends Thread {
    ...
    class C02071 implements Runnable {
        ...
        C02071(zzc com_google_android_gms_internal_zzc, zzk com_google_android_gms_internal_zzk) {
                ...
                if (com_google_android_gms_internal_zzk.isCanceled()) {
                    ...
                    if (zza == null) {
                        ...
                        if (zza.zzb()) {
                            ...
                            com_google_android_gms_internal_zzk.zza(zza);
                            zza2.zzbh = true;
                            this.zzj.zza(com_google_android_gms_internal_zzk, zza2, new C02071(this, com_google_android_gms_internal_zzk));
                        } else {

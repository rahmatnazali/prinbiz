...
public class zzv implements zzb {
    ...
    static class zza {
        ...
        public static zza zzf(InputStream inputStream) throws IOException {
            ...
            if (com_google_android_gms_internal_zzv_zza.zza.equals(XmlPullParser.NO_NAMESPACE)) {
        ...
        public boolean zza(OutputStream outputStream) {
            try {
                ...
                zzv.zza(outputStream, this.zza == null ? XmlPullParser.NO_NAMESPACE : this.zza);
    ...
    public zzv(File file) {
        this(file, HitiPPR_PrinterCommand.MAX_DATA_SIZE);
    }
    ...
    static void zza(OutputStream outputStream, int i) throws IOException {
        outputStream.write((i >> 0) & TelnetOption.MAX_OPTION_VALUE);
        outputStream.write((i >> 8) & TelnetOption.MAX_OPTION_VALUE);
        outputStream.write((i >> 16) & TelnetOption.MAX_OPTION_VALUE);
        outputStream.write((i >> 24) & TelnetOption.MAX_OPTION_VALUE);
    }
    ...
    public synchronized void initialize() {
        ...
        r0 = 0;
        monitor-enter(r9);
        r1 = r9.zzby;	 Catch:{ all -> 0x006c }
        r1 = r1.exists();	 Catch:{ all -> 0x006c }
        if (r1 != 0) goto L_0x0025;
    L_0x000a:
        r0 = r9.zzby;	 Catch:{ all -> 0x006c }
    ...
    L_0x0031:
        ...
        r6 = r1.zzcb;	 Catch:{ IOException -> 0x0078 }

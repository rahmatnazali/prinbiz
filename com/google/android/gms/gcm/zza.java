...
class zza {
    ...
    static boolean zzac(Bundle bundle) {
        return OADCItem.WATCH_TYPE_WATCH.equals(zzf(bundle, "gcm.n.e")) || zzf(bundle, "gcm.n.icon") != null;
    }

    static void zzad(Bundle bundle) {
        String str;
    ...
    private Notification zzaf(Bundle bundle) {
        ...
        Uri zzkb = zzkb(zzf(bundle, "gcm.n.sound2"));
        PendingIntent zzag = zzag(bundle);
        Builder smallIcon = new Builder(this.mContext).setAutoCancel(true).setSmallIcon(zzka);
    ...
    static synchronized zza zzdb(Context context) {
        zza com_google_android_gms_gcm_zza;
        synchronized (zza.class) {
            if (Zd == null) {
                Zd = new zza(context);
            }
            com_google_android_gms_gcm_zza = Zd;
        }
    ...
    private String zzg(Bundle bundle, String str) {
        ...
        if (identifier == 0) {
            ...
            valueOf2 = String.valueOf(zzjz(valueOf2.length() != 0 ? valueOf3.concat(valueOf2) : new String(valueOf3)));
        ...
        try {
            ...
            valueOf2 = String.valueOf("_loc_args");
            valueOf2 = String.valueOf(zzjz(valueOf2.length() != 0 ? str2.concat(valueOf2) : new String(str2)));
    ...
    private String zzjz(String str) {

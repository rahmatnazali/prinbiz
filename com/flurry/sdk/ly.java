...
public final class ly {
    private static final Pattern f433a;

    static {
        f433a = Pattern.compile("/");
    }

    public static String m343a(String str) {
    ...
    public static String m346b(String str) {
        if (TextUtils.isEmpty(str)) {
            return str;
        }
        URI i = m354i(str);
        ...
        i = m345a(i.getScheme(), i.getAuthority(), "/", null, null);
        if (i != null) {
            return i.toString();
        }
        return str;
    ...
    public static String m344a(String str, String str2) {
        ...
        String[] split = f433a.split(path, -1);
        String[] split2 = f433a.split(path2, -1);
        ...
        i = m345a(null, null, stringBuilder.toString(), scheme2, fragment);
        if (i != null) {
            return i.toString();
        }
        return str;
    ...
    private static URI m354i(String str) {
        try {
            return new URI(str);
    ...
    private static URI m345a(String str, String str2, String str3, String str4, String str5) {
        try {
    ...
    public static boolean m349d(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean m350e(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
        Uri parse = Uri.parse(str);
    ...
    public static boolean m351f(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
        Uri parse = Uri.parse(str);
    ...
    public static boolean m352g(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
    ...
    public static boolean m353h(String str) {
        if (TextUtils.isEmpty(str)) {
            return false;
        }
        URI i = m354i(str);
    ...
    public static String m347b(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            try {

...
public class GarnishSecurity_520 {
    ...
    void DeleteExpire(String strExpireConfigPath, GarnishSecurityInfo garnishSecurityInfo) {
        ...
        String strRootFilePath = this.m_Context.getExternalFilesDir(null).getAbsolutePath();
        for (int i = 0; i < garnishSecurityInfo.GetItemNumbers(); i++) {
            if (garnishSecurityInfo.GetConfigType().contains("cgarnish")) {
                ...
                FileUtility.DeleteALLFolder(strRootFilePath + "/" + PringoConvenientConst.V_BORDER_PATH + "/" + GarnishItemUtility.GetGarnishFolderName(garnishSecurityInfo.GetItemName(i), 1));
                FileUtility.DeleteFile(strRootFilePath + "/" + PringoConvenientConst.V_BORDER_PATH + "/" + PringoConvenientConst.THUMB + "/" + garnishSecurityInfo.GetItemName(i));
            } else if (garnishSecurityInfo.GetConfigType().contains("hborder")) {
                FileUtility.DeleteALLFolder(strRootFilePath + "/" + PringoConvenientConst.H_BORDER_PATH + "/" + GarnishItemUtility.GetGarnishFolderName(garnishSecurityInfo.GetItemName(i), 1));
                FileUtility.DeleteFile(strRootFilePath + "/" + PringoConvenientConst.H_BORDER_PATH + "/" + PringoConvenientConst.THUMB + "/" + garnishSecurityInfo.GetItemName(i));
    ...
    private String SearchVerifyFolderPath(String strConfigType, String strPath) {
        if (strConfigType.contains("cgarnish")) {
            ...
            return FileUtility.GetFolderFullPath(strPath).replace("/thumb", XmlPullParser.NO_NAMESPACE) + "/" + GarnishItemUtility.GetGarnishFolderName(strPath, 1);

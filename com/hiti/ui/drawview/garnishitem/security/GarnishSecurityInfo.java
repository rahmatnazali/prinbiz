...
public class GarnishSecurityInfo {
    ...
    public GarnishSecurityInfo(String strExpire, String strConfigType, int iItemNumbers, ArrayList<Long> lItemSizeList, ArrayList<String> strItemNameList) {

...
public class HitiPPR_PaperJamRun extends HitiPPR_PrinterCommandNew {
    ...
    private boolean CheckPrinterStatusPaperJam(byte[] mStatusFlag) {
        ...
        if (ByteConvertUtility.CheckBit(mStatusFlag[1], (byte) 2) != null) {
            return true;
        }
        return false;
    }
    ...
    private boolean CheckPrinterStatusCoverOpen(byte[] mStatusFlag) {
        ...
        if (ByteConvertUtility.CheckBit(mStatusFlag[2], (byte) 8) != null) {
            return true;
        }
        return false;
    }
    ...
    private boolean CheckPrinterStatusNotBusy(byte[] mStatusFlag) {
        ...
        if (ByteConvertUtility.CheckBit(mStatusFlag[0], Byte.MIN_VALUE) == null) {
            return true;
        }
        return false;
    }

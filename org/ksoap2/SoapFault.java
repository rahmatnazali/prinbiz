...
public class SoapFault extends IOException {
    ...
    public SoapFault() {
        this.version = POP3.DEFAULT_PORT;
    }
    ...
    public void write(XmlSerializer xw) throws IOException {
        ...
        xw.text(new StringBuffer().append(XmlPullParser.NO_NAMESPACE).append(this.faultcode).toString());
        xw.endTag(null, "faultcode");
        xw.startTag(null, "faultstring");
        xw.text(new StringBuffer().append(XmlPullParser.NO_NAMESPACE).append(this.faultstring).toString());

...
public class LookAheadReader extends Reader {
    ...
    public LookAheadReader(Reader r) {
        this.buf = new char[(Runtime.getRuntime().freeMemory() > 1000000 ? AccessibilityNodeInfoCompat.ACTION_COPY : TransportMediator.FLAG_KEY_MEDIA_NEXT)];
        this.bufPos = 0;
        this.bufValid = 0;
        this.reader = r;
    }
    ...
    public String readLine() throws IOException {
        ...
        String s = readTo(SocketClient.NETASCII_EOL);
